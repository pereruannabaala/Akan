function readData() {
	const dd = document.getElementById("dd").value; //get value of date inputed 
	const mm = document.getElementById("mm").value; //get value of month inputed 
	const yy = document.getElementById("yy").value; //get value of year inputed
	...
	if (dd <= 0 || dd > 31) { //ensures user enters a date and validates date entered for months with 31 days
		...
		document.getElementById("result").style.color = "cadetblue"
